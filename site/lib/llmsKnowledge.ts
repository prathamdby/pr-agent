...
export const KNOWLEDGE_CHUNKS: readonly KnowledgeChunk[] = [
  ...
  },
  {
    ...
    body: lines([
      ...
      "A custom OpenAI-compatible provider is a models.json key with baseUrl, api, and apiKey; set PI_PROVIDER and PI_MODEL to that key. Fields and example: docs/configuration.md.",
    ]),
  },
  {
    id: "alternatives",
