...
export const KNOWLEDGE_CHUNKS: readonly KnowledgeChunk[] = [
  ...
  },
  {
    ...
    body: lines([
      ...
      "A VPS plus Dokploy or Coolify is a TLS front for pr-agent-web. Route only the web service on internal port 7224. Leave Postgres unpublished. Keep DATABASE_URL on hostname postgres. Do not add a second compose file or expose the worker. Hetzner is the usual cheap 4 GB VPS. Hostinger and DigitalOcean also work. See README Recommended hosts.",
