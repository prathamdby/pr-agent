...
export const KNOWLEDGE_CHUNKS: readonly KnowledgeChunk[] = [
  ...
  },
  {
    ...
    body: lines([
      ...
      "Maintainers changing code start docker compose -f docker-compose.dev.yml up -d --build. That file starts Postgres (published on 5432), Caddy with an internal certificate, web, and worker. Production hosting still uses docker compose up. Caddy site names live in that file. GitHub does not trust the internal certificate. Tunnel to the web webhook path.",
