...
export const KNOWLEDGE_CHUNKS: readonly KnowledgeChunk[] = [
  ...
  },
  {
    ...
    body: lines([
      ...
      "check_run and status write pr_head_ci_state and enqueue a debounced ci-projection job. The worker does not consume that queue yet. CI-refresh reads the table.",
