...
export function DiffField({ className }: DiffFieldProps) {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="animate-diff-drift absolute -inset-16 grid grid-cols-[repeat(20,minmax(0,1fr))] gap-x-3 gap-y-2 font-mono text-[11px] leading-none text-ink-faint/35 sm:text-xs">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,var(--color-forge)_72%)]" />
    </div>
  );
}
