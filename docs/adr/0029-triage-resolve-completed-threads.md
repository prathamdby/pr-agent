# ADR 0029 — Triage resolves completed threads
...
This amends ADR 0013 decision (6) and the “triage never resolves dismissed” clauses in ADR 0015 and ADR 0016.
