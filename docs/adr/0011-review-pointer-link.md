...
Amended by [ADR 0028](0028-orchestrated-review.md). The rule applies to the single general review summary for the pull request.
...
5. **Publish order** — incremental inline thread batches first ([ADR 0028](0028-orchestrated-review.md)), summary upsert last.
