...
- **Lint/fmt commands**: `nub run lint` (oxlint, type-aware, enabled rules are errors), `nub run typecheck` (tsc), `nub run fmt:check` (oxfmt). Combined: `nub run check:code`. See [development.md](development.md) Lint.
