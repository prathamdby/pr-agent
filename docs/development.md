...
| Code Mode                        | `src/agent/codemode/`, `src/agent/execution/` | `execute({ code })` QuickJS cell; `tools.*` delegates to canonical workspace capabilities; terminal submit/publish tools stay native siblings                                                                                                                |
