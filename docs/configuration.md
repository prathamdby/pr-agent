...
| Cursor API key           | `CURSOR_API_KEY`              | empty         | legacy; ignored for runtime selection (removed with Cursor SDK)                                                                                                                                                                |
| Cursor ripgrep path      | `CURSOR_RIPGREP_PATH`         | empty         | legacy; ignored for runtime selection                                                                                                                                                                                          |
