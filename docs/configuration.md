...
| LLM provider                | `PI_PROVIDER`                               | `openai`                    | Pi coding-agent model provider (built-in slug, or a provider key from project-root `models.json` when that file is present)                                                                                                                                                                                                                                |
...
- The runtime image does not bake in `models.json`; mount or copy it to the process cwd before deploy.
