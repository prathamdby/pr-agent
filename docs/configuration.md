...
| `REVIEW_FINDING_VIOLATED_RULE_MAX_CHARS`                                                                               | 80 (optional `.pr-agent/<name>.mdc` path on a finding)                                         |
...
| `AGENT_EVENTS_RETENTION_SECONDS`         |
| `AGENT_RESUME_SNAPSHOT_KEY`              |
| `AGENT_RESUME_SNAPSHOT_MARGIN_SECONDS`   |
...
| `FINDING_HISTORY_DISMISS_SUPPRESS_AFTER` |
| `FINDING_HISTORY_ENABLED`                |
| `FINDING_HISTORY_LOOKBACK_DAYS`          |
| `GITHUB_APP_ID`                          |
...
| `QUEUE_DELETE_AFTER_SECONDS`             |
| `QUEUE_EXPIRE_IN_SECONDS`                |
...
| `SLASH_ALLOWED_ASSOCIATIONS`             |
| `TRIAGE_CONCURRENCY`                     |
| `VERIFICATION_CONCURRENCY`               |
| `WEBHOOK_EVENTS_RETENTION_SECONDS`       |
| `WEBHOOK_SECRET`                         |

<!-- END GENERATED ENV CATALOG -->
