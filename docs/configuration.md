...
| Landing site PostHog token        | `VITE_POSTHOG_PROJECT_TOKEN`             | empty                    | public project key for `site/` `$pageview` via posthog-js; empty skips the SDK. Vite-only (`VITE_` prefix). Not the worker `POSTHOG_PROJECT_TOKEN`                                                                                          |
| Landing site PostHog host         | `VITE_POSTHOG_HOST`                      | empty                    | optional host override for the landing site; empty uses the posthog-js default                                                                                                                                                              |
