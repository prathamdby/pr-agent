...
| Workspace search byte cap | `LOCAL_WORKSPACE_SEARCH_MAX_TOTAL_BYTES`    | `50000000`                  | legacy JS search scan byte cap; `searchWorkspace` now uses git grep instead of reading every file                                                                                                                                                                                                                                                          |
