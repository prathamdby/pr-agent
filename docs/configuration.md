...
| PostHog token       | `POSTHOG_PROJECT_TOKEN`  | empty                    | optional analytics; empty disables capture                                                                                                                                                                                                                                                                                                                 |
...
| `REVIEW_CI_SUMMARY_WAIT_MS` / `REVIEW_CI_SUMMARY_WAIT_POLL_MS` / `REVIEW_CI_SUMMARY_MAX_FAILURES`                    | 15000 / 2000 / 3 — CI summary gate wait, poll, and failure-digest caps                                                                                                      |
