...
| Specialist attempt timeout | `REVIEW_SPECIALIST_TIMEOUT_MS`     | `900000`                    | per-specialist wall-clock cap (orchestrator V2); timeout aborts then disposes the session, retries only while budget/deadline remains                                                                                                |
