...
export const ENV = {
  ...
  MAX_TOOL_ROUNDS_REVIEWER: "MAX_TOOL_ROUNDS_REVIEWER",
  MAX_TOOL_ROUNDS_VALIDATOR: "MAX_TOOL_ROUNDS_VALIDATOR",
  MAX_TOOL_ROUNDS_ORCHESTRATOR: "MAX_TOOL_ROUNDS_ORCHESTRATOR",
  MAX_TOOL_ROUNDS_CRITIC: "MAX_TOOL_ROUNDS_CRITIC",
  REVIEW_CRITIC_MAX_INVESTIGATION_CALLS: "REVIEW_CRITIC_MAX_INVESTIGATION_CALLS",
  REVIEW_PIPELINE_MODE: "REVIEW_PIPELINE_MODE",
  REVIEW_SHADOW_SAMPLE_RATE: "REVIEW_SHADOW_SAMPLE_RATE",
  ...
  REVIEW_AGENT_CONCURRENCY: "REVIEW_AGENT_CONCURRENCY",
  REVIEW_VALIDATION_MAX_CANDIDATES: "REVIEW_VALIDATION_MAX_CANDIDATES",
  ...
  QUEUE_STALL_DIAGNOSTICS_INTERVAL_SECONDS: "QUEUE_STALL_DIAGNOSTICS_INTERVAL_SECONDS",
  WORKER_READINESS_POLL_STALE_SECONDS: "WORKER_READINESS_POLL_STALE_SECONDS",
  ...
  ENABLE_REVIEW_CHECK_RUN: "ENABLE_REVIEW_CHECK_RUN",
