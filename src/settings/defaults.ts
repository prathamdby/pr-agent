...
export const DEFAULT_MAX_TOOL_ROUNDS = 16;
export const DEFAULT_MAX_TOOL_ROUNDS_REVIEWER = 16;
export const DEFAULT_MAX_TOOL_ROUNDS_VALIDATOR = 8;
export const DEFAULT_MAX_TOOL_ROUNDS_ORCHESTRATOR = 8;
...
export const DEFAULT_REVIEW_AGENT_CONCURRENCY = 4;
export const DEFAULT_REVIEW_VALIDATION_MAX_CANDIDATES = 16;
...
export const DEFAULT_QUEUE_STALL_DIAGNOSTICS_INTERVAL_SECONDS = 60;
export const DEFAULT_WORKER_READINESS_POLL_STALE_SECONDS = 30;
