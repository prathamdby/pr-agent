...
export const DEFAULT_MAINTAINER_DECISION_ASSOCIATIONS = "OWNER,MEMBER,COLLABORATOR";
export const DEFAULT_MAINTAINER_DECISION_ASSOCIATION_SET: ReadonlySet<string> = new Set(
  DEFAULT_MAINTAINER_DECISION_ASSOCIATIONS.split(","),
);
...
/** Same window as work-item retention. Set the env to 0 to keep agent_events rows forever. */
export const DEFAULT_AGENT_EVENTS_RETENTION_SECONDS = DEFAULT_AGENT_WORK_RETENTION_SECONDS;
