...
export const DEFAULT_MAX_TOOL_ROUNDS_CRITIC = 4;
export const DEFAULT_REVIEW_CRITIC_MAX_INVESTIGATION_CALLS = 3;
export const DEFAULT_REVIEW_PIPELINE_MODE = "legacy" as const;
export const DEFAULT_REVIEW_SHADOW_SAMPLE_RATE = 0;
