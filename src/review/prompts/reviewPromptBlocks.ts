...
export const causalPublicationContract = [
  ...
  "- The specific behaviour this pull request introduced or exposed that is incorrect or harmful.",
  ...
  "One root cause with multiple symptoms stays one finding. Separately fixable root causes stay separate findings. Split a compound candidate before submission, or keep only the single evidenced problem.",
