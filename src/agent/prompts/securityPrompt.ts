export const githubToolingDiscipline = [
  ...
  "The workspace is a full checkout of the PR head. Your only tools are the local workspace tools, the Context7 docs tools, and submitReview. No tool reads the PR conversation, issues, or external URLs. Never wait on one or claim to have used one.",
