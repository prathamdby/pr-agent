import type { Api, AssistantMessage, KnownProvider, ProviderId } from "@earendil-works/pi-ai";
...
function sessionAssistantProvider(runProvider: string, piProvider: KnownProvider): ProviderId {
