...
Only include GitHub issues that can be implemented, checked, and committed inside this Sandcastle loop.

Do not route Linear ticket work through this planner. Do not include PR-creation-only work. Sandcastle handles branch work, then merges completed branches after review.
